...
---------
##Flowchart
&nbsp;&nbsp;&nbsp;&nbsp;The flowchart as shown in *[Figure 34](img\flowcharts\03_combine_data.jpg)* is in the first (purple) section of the [fundamental flowchart](img\flowcharts\flowchart cuts.png) as shown in the [*Planning - products*](/a1.1_Product/#fundamental-flowchart).

<figure>
  <img src="..\img\flowcharts\03_combine_data.jpg" alt="Flowchart - Combine data" style="width:80%; height:80%;">
  <figcaption>Figure 34: Flowchart - Combine data</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Figure 35: Final result - Combine data</figcaption>
</figure>