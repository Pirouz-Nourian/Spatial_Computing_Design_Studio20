...
&nbsp;&nbsp;&nbsp;&nbsp; This research started with analysing the building plot: as you can see in *[Figure 5](img\1\1_surrounding_environment.png)* the site is devided in a compulsory part and a optional part. To keep the streets intact, we decided to stay within the borders of the comulsory building plot.
