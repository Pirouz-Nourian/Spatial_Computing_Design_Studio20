...
<figure>
  ...
  <figcaption>Figure X: Flowchart - Generative Relations mcda</figcaption>
</figure>
...
----
###Pseudo code
&nbsp;&nbsp;&nbsp;&nbsp;For a better understanding of the code, we wrote a pseudo code. The [notebook](notebooks\09_generative_relations_mcda.ipynb), and the other notebooks, can be found [here](/index/scripts/).
...
<figure>
  ...
  <figcaption>Figure 2: GIF - Growing</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Figure X: Visualisation Generative Relations mcda</figcaption>
</figure>
